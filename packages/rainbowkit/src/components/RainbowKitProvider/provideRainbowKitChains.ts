...
type ChainMetadataOverride = Omit<ChainMetadata, "chainId">;
...
const chainMetadataById: Record<number, ChainMetadataOverride> = Object.fromEntries(
...
export const provideRainbowKitChains = <Chain extends RainbowKitChain>(chains: readonly [Chain, ...Chain[]]): Chain[] =>
  chains.map((chain) => {
