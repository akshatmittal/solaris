...
describe("formatENS", () => {
  it("trucates ENS name over 24 characters", () => {
    expect(formatENS("reallylongensnameheretotestlongnames.eth")).toEqual("reallylongensnameheretot...");
  });
  ...
  it("Subdomains are taken into account", () => {
    expect(formatENS("rainbowrainbowrainbow.rainbowrainbow.eth")).toEqual("rainbowrainbowrainbow.ra...");
  });
